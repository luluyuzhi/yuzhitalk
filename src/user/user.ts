...
export class User<T> implements ICommonPropsHandler<T> {
  ...
  constructor(
    ...
    // this.connector.OnClose(this.OnClose.bind(this));
    // this.connector.OnError(this.OnError.bind(this));
    // this.connector.Connect();
    // this.subscriptionServer = subscriptionServer;
    const selfSubscription = this.subscriptionServer.addSubscription(this.userId as any);
  }
...
export class Group<T> implements ICommonPropsHandler<T> {
  ...
  constructor(private readonly groupId: T) { }
